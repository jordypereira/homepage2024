  ...
  <div class="min-h-screen pb-12 bg-white">
    <main class="md:max-w-4xl mx-6 md:mx-auto md:px-6">
      <section>
        ...
        <p>
          Living in <span class="text-yellow-600">Stockholm, Sweden</span>. Grown up in <span
            class="text-red-700"
          >Belgium</span>, with
      ...
      <section class="mt-12">
        ...
        <ol>
          ...
          <li>
            <span class="text-red-600">2019 - 2021 </span> Prorenata - Frontend Developer
          </li>
          <li>
      ...
      <section class="mt-12">
        ...
        <ul>
          <li>
            <Dot />Currently leading a team of 5 developers to create a seamless E-commerce experience.
          </li><li><Dot />Experience leading projects with over 20 stakeholders, migrating large parts of a codebase and system.</li>
