  ...
  <div class="min-h-screen pb-12 bg-white">
    <main class="md:max-w-4xl mx-6 md:mx-auto md:px-6">
      <section>
        ...
        <p>
          Living in <span class="text-yellow-600">Stockholm, Sweden</span>. Grown up in
          <span class="text-red-700">Belgium</span>, with roots in
          <span class="text-red-500">Portugal</span> and <span class="text-blue-500">Greece</span>.
        </p>
      ...
      <section class="mt-12">
        ...
        <ol>
          <li>
            <span class="text-red-600">2023 - 2100 </span> Happy Socks - Lead Developer E-Commerce
          </li>
          <li>
            <span class="text-red-600">2021 - 2023 </span> Happy Socks - Senior Frontend Developer
          </li>
          <li><span class="text-red-600">2019 - 2021 </span> Prorenata - Frontend Developer</li>
          <li>
            <span class="text-red-600">2016 - 2019</span>
            Karel de Grote University College - Bachelor in Science - Multimedia Technology: Web &
            UX
          </li>
        </ol>
      </section>
      ...
      <section class="mt-12">
        ...
        <ul>
          ...
          <li>
            <Dot />Experience leading projects with over 20 stakeholders, migrating large parts of a
            codebase and system.
          </li>
          <li>
            <Dot />Helped transition a monolith Magento 2 Ecommerce website to be fully composable,
            with a modern Nuxt 3 frontend, serverless functions, headless CMS, Commerce API,
